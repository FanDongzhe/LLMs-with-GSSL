...
def main():
    ...
    save_path_model = 'weight/s2gaesvm-' + args.use_sage +'_'+ args.feature_type + '_{}_{}'.format(args.dataset, args.mask_type) + '_{}'.format(
        args.num_layers) + '_hidd{}-{}-{}-{}'.format(args.hidden_channels, args.mask_ratio, args.decode_layers,
                                                     args.decode_channels) + '_model.pth'
    save_path_predictor = 'weight/s2gaesvm' + args.use_sage +'_'+ args.feature_type + '_{}_{}'.format(args.dataset,
